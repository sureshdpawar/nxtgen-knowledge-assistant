...
function actionSummary(
  ...
  return (
    `${first} +${approval.actions.length - 1} more`
  );
}
      ...
      <div className="flex max-h-[92vh] w-full max-w-3xl flex-col overflow-hidden rounded-t-2xl bg-white shadow-2xl sm:rounded-2xl">
        <div className="flex shrink-0 items-start justify-between gap-4 border-b border-slate-200 px-5 py-4">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Review the exact proposed action before allowing the paused agent run to continue.
            </p>
          </div>
          ...
          <section>
            <div className="flex items-center justify-between gap-3">
              ...
              <span className="text-xs text-slate-500">
                {approval.actions.length} action
                {approval.actions.length
                  === 1
                  ? ""
                  : "s"}
          ...
          {isPending && (
            <section>
              ...
              <textarea
                ...
                className="mt-2 w-full resize-y rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
              />
            </section>
          )}
        ...
        <div className="flex shrink-0 flex-col-reverse gap-2 border-t border-slate-200 bg-white px-5 py-4 sm:flex-row sm:justify-end">
          <button
            ...
            className="inline-flex h-10 items-center justify-center rounded-lg border border-slate-300 bg-white px-4 text-sm font-semibold text-slate-700 hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50"
          >
            Close
          </button>
          ...
          {isPending && (
            <>
              <button
                ...
                className="inline-flex h-10 items-center justify-center gap-2 rounded-lg border border-rose-200 bg-white px-4 text-sm font-semibold text-rose-700 hover:bg-rose-50 disabled:cursor-not-allowed disabled:opacity-50"
              >
              ...
              <button
                ...
                className="inline-flex h-10 items-center justify-center gap-2 rounded-lg bg-blue-600 px-4 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-50"
              >
      ...
      <div className="rounded-xl border border-amber-200 bg-amber-50 p-5 text-sm text-amber-900">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1">
              Agent action approvals are available only to tenant Admin users.
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="max-w-3xl text-sm text-slate-600">
          Review agent-proposed actions that require human approval before the paused workflow can continue.
        </p>
      </div>
      ...
      {decisionNotice && (
        <div className="flex items-start gap-3 rounded-xl border border-blue-200 bg-blue-50 p-4 text-sm text-blue-900">
          ...
          <button
            ...
            className="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-blue-700 hover:bg-blue-100"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
      ...
      <section className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
        <div className="flex flex-col gap-1 border-b border-slate-200 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-xs text-slate-500">
              One approval record represents one paused agent checkpoint and may contain multiple proposed tool actions.
            </p>
          </div>
        ...
        {isError && (
          <div className="m-5 flex items-start gap-3 rounded-xl border border-rose-200 bg-rose-50 p-4 text-sm text-rose-800">
            <AlertTriangle className="mt-0.5 h-5 w-5 shrink-0" />
        ...
        {!isLoading
          ...
          && (
            <div className="px-5 py-12 text-center">
              ...
              <p className="mt-1 text-xs text-slate-500">
                Agent actions will appear here when their execution policy requires Admin approval.
              </p>
            </div>
          )}
          ...
          onClose={
            (resolved) => {
              ...
              if (
                ...
                setDecisionNotice(
                  "This approval was recorded successfully. The resumed agent has proposed another action that also requires approval.",
                );
                return;
              }
              ...
              setDecisionNotice(
                resolved.status
                === "APPROVED"
                  ? "The action was approved and the agent run resumed."
                  : "The action was rejected and the agent run resumed.",
              );
            }
          }
        />
